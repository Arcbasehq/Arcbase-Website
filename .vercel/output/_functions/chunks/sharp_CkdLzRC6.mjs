import { A as AstroError, n as MissingSharp } from './entrypoint_C7optSfK.mjs';
import { b as baseService, p as parseQuality } from './generic_B8Y-Oxc8.mjs';
...
async function loadSharp() {
  let sharpImport;
  try {
    sharpImport = (await import('./index_CrUtea0J.mjs').then(n => n.i)).default;
  } catch {
